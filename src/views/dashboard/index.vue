      ...
      <el-col :xs="12" :sm="12" :lg="6">
        <div class="box4 widget-card">
          ...
          <div class="rightPart">
            ...
            <div class="font-center">违规操作</div>
          </div>
        </div>
      </el-col>
    </el-row>
      ...
      <el-col :sm="24" :lg="12">
        <el-card shadow="hover" class="system-report">
          ...
          <div class="report-content">
              <el-alert title="系统崩溃率" type="error"></el-alert>
              <el-alert title="系统运行占比" type="info"></el-alert>
              <el-alert title="系统处理率" type="success"></el-alert>
            <el-row :gutter="24">
              ...
              <el-alert title="重大异常" type="warning"></el-alert>
              <el-alert title="处理异常" type="error"></el-alert>
          </div>
        </el-card>
      </el-col>
      <el-col :sm="24" :lg="12">
...
const chartData = {
  ...
  fpsGame: [
    { value: 320, name: "完成订单数" },
    { value: 240, name: "异常订单" },
    { value: 149, name: "客户意见" },
    { value: 400, name: "配送员违规" },
    { value: 524, name: "商家严重违规" }
  ],
  fpsLegend: [
    "完成订单数",
    "异常订单",
